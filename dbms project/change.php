...
$errors['phone1']= "phone no is min 10 digits".'<br/>';
    ...
    if(array_filter($errors)){
      ...
      $sql = "UPDATE user set f_name = '$firstname',l_name = '$lastname' ,email ='$e_mail',category = '$category',password = '$password',aadhar = $aadhar  WHERE user_id ='$user_id'";
      $mult="UPDATE mu set phone1 ='$phone1',phone2 = '$phone2' WHERE user_id ='$user_id'";
...
<body>
  ...
  <form class="red"method="POST" style="border:1px solid #ccc">
    ...
    <h1>Sign Up</h1>
    <p>Please fill in this to change the  account details .</p>
    <hr>            
