...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="#">candidate</a>
      <a href="https://eci.gov.in/files/file/12251-observer-hand-book-vol-i-ii-iii-september-2020-edition-6/">voter</a>
      <a href="#">admin</a>
    </div>
  </li>
<li><a href="query.php">Any query?</a></li>
<li><a href="#para3">About</a></li>
<li><a href="#para1">rate us</a></li>
<li><a href="ratepage.php">view rating</a></li>
<li style="float:right"><a href="add.php">Sign in</a></li>
